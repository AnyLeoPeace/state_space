...
from models.my_transformer import PosEncodingLayer, add_layer
...
class attentive_state_space_model:
    ...
    ** Key methods **
    ...
    def build_transformer_model(self, transformer_depth = 4, transformer_dropout = 0.1, num_heads = 2, confidence_penalty_weight = 0.1, d_model = 16):

        # Input
        input_data = Input(shape=(self.maximum_seq_length, self.input_dim))
        ...
        model = Model(inputs=[input_data,input_time, input_states], outputs=pred)
